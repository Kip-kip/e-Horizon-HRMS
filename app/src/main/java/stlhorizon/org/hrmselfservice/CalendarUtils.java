...
public class CalendarUtils {
    ...
    /**
     * Formats given time to a readable day string, e.g. Sunday 20
     * @param context       resources provider
     * @param timeMillis    time in milliseconds
     * @return  formatted day string
     */
    public static String toDateString(Context context, long timeMillis) {
    ...
    /**
     * Formats given time to a readable year string, e.g. 20
     * @param context       resources provider
     * @param timeMillis    time in milliseconds
     * @return  formatted month string
     */
    public static String toDateOnlyString(Context context, long timeMillis) {
        return DateUtils.formatDateRange(context, timeMillis, timeMillis,
                DateUtils.FORMAT_SHOW_WEEKDAY);
    }
    /**
     * Formats given time to a readable year string, e.g. Mar
     * @param context       resources provider
     * @param timeMillis    time in milliseconds
     * @return  formatted month string
     */
    public static String toMonthOnlyString(Context context, long timeMillis) {
        return DateUtils.formatDateRange(context, timeMillis, timeMillis,
